...
@Module({
  ...
  providers: [AiGatewayService, ProviderAdapterRegistry, AwsBedrockProviderAdapter, GoogleVertexProviderAdapter, FakeProviderAdapter],
  exports: [AiGatewayService, ProviderAdapterRegistry, AwsBedrockProviderAdapter, GoogleVertexProviderAdapter, FakeProviderAdapter]
})
